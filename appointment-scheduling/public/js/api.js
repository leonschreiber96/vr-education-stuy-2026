...
export const AdminAPI = {
   ...
   updateBookingResultStatus: (id, resultStatus) => API.patch(`/admin/bookings/${id}/result-status`, { resultStatus }),
   ...
   sendBulkEmail: (data) => API.post("/admin/send-bulk-email", data),
};
